                    ...
                    <div class="col">
                        <div class="card panunote-elements">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <i class="bi bi-question-square  text-primary fs-4"></i>

                                    <span class="card-title text-primary fs-4">Discover Top Quizzes</span>
                                </div>
                                ...
                                <p class="card-text">This is a longer card with supporting text below as
                                    a natural lead-in to additional content. This content is a little
                                    bit longer.</p>
                                <a href="/browse/quizzes" class="stretched-link"></a>
                            </div>
                        </div>
                                            ...
                                            <table class="table table-striped table-hover fs-4">
                                                <thead>
                                                    <tr class="text-center">
                                                        ...
                                                        <th scope="col"><i class="bi bi-heart-fill text-primary"></i>
                                                            Likes</th>
                                                        <th scope="col"><i
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($toplikes as $topl)
                                                        <tr class="text-center"
                                                            wire:click="visit({{ $topl->subject_id }})"
                                            ...
                                            <table class="table table-striped table-hover fs-4">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($topvisits as $topv)
                                                        <tr class="text-center"
                                                            wire:click="visit({{ $topv->subject_id }})"
                                                            style="cursor: pointer;">
                                                            <td>
                                                                @if ($count == 1)
                                                                    <span
