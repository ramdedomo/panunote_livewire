                    ...
                    <div>
                        ...
                        <div class="col-10">
                            <div class="input-group">
                                ...
                                <input placeholder="@error('subjecttitle'){{ $message }}@enderror" type="text" wire:model="subjecttitle" id="subjecttitle" class="form-control form-control-sm">
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                            <div class="form-check form-switch">
                                @error('subjectsharing') <span class="error">{{ $message }}</span> @enderror
                                <input class="form-check-input" role="switch" type="checkbox" wire:model="subjectsharing" id="subjectsharing" data-onstyle="primary">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <div>
                            ...
                            <span wire:loading wire:target="submit">
                                <span id="spinner" class="spinner-grow spinner-grow-sm justify-content-center p-0 m-0" role="status" aria-hidden="true"></span>
                            </span> 
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="card note-card rounded-3 border border-1 border-primary border-opacity-25">
                            <div class="card-header border-bottom border-primary border-2 d-flex justify-content-between">
                                ...
                                <div>
                                    <p class="p-0 m-0" id="title">{{ $subject->updated_at->format('m/d/Y') }}</p>
                                </div>
                            </div>
