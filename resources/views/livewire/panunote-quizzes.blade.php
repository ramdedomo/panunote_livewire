            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 mb-3" wire:ignore>
                            Tags: <br>
                            <select wire:model="quizcreate_tags" data-width="100%"class="selectpicker" data-live-search="true"  multiple data-selected-text-format="count" data-actions-box="true">
                                @foreach ($tags as $t)
                        ...
                        <div class="col-4 mb-3" wire:ignore>
                            Difficulty: <br>
                            <select wire:model="quizcreate_diff" data-width="100%" class="selectpicker" multiple data-selected-text-format="count" data-actions-box="true">
                        ...
                        <div class="col-4 mb-3" wire:ignore>
                            ...
                            <select class="selectpicker" title="Nothing Selected" wire:model="quizcreate_count" data-width="100%">
                        ...
                        <div class="col-6" wire:ignore>
                            Tags Precision: <br>
                            <select class="selectpicker" title="Nothing Selected" wire:model="quizcreate_precision" data-width="100%">
                        ...
                        <div class="col-6" wire:ignore>
                            Question Sorting:<br>
                            <select class="selectpicker" title="Nothing Selected" wire:model="quizcreate_sorting" data-width="100%">
                        ...
                        <div class="row align-items-center">
                            <div class="col-10">
                               ...
                               <div class="input-group">
                                   ...
                                   <input wire:model="quizcreate_title" type="text" class="form-control" placeholder="Quiz Title">
                               </div>
                           </div>
                           ...
                           <div class="col-2">
                            <div class="form-check form-switch">
                             <br>
                                <input class="form-check-input" role="switch" type="checkbox" wire:model="quizcreate_sharing" id="quizcreate_sharing" data-onstyle="primary">
                ...
                <div class="w-100 modal-footer justify-content-between">
                        ...
                        <div>
                            ...
                            <button type="submit"  wire:click="create_quiz" class="btn btn-primary">Create &nbsp;<i class="bi bi-journal-text"></i></button>
                        </div>
                ...
                <div class="p-3 m-0">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <div class="d-flex" wire:ignore> 
                            ...
                            <div class="mx-1"></div>
                            <div>
                                <input wire:model="search" style="width: 150px" class="form-control" type="text" placeholder="Search"
